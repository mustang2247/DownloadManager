...
import com.github.phoenix.utils.APNUtil;
import com.github.phoenix.utils.Constants;
import com.github.phoenix.utils.Strings;
...
//                callback.execute();
            ...
            public void execute() {
                ...
                intent.putExtra(UpdateService.BUNDLE_KEY_DOWNLOAD_URL, update_url);
...
//                    callback.execute();
                    ...
                    Toast toast = Toast.makeText(context, "正在更新中，请稍后...", Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
